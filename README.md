...
Шаг 5: Фронтенд - Дашборд аналитики
    ...
    Отрисовать круговую диаграмму расходов и линейный график изменения баланса.

    Добавить продвинутые визуализации: диаграмму Сэнки (Sankey) для анализа потоков средств, тепловую карту (Heatmap) ежедневных трат и график кумулятивного сравнения трат месяца к месяцу.
